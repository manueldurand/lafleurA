 ...
 * LafleurClients
 *
 * @ORM\Table(name="lafleur_clients", uniqueConstraints={@ORM\UniqueConstraint(name="emailClient_UNIQUE", columns={"email_client"})}, indexes={@ORM\Index(name="fk_lafleur_clients_lafleur_adresses1_id", columns={"lafleur_adresses_id"})})
 * @ORM\Entity
 */
