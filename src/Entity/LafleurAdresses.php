 ...
 * LafleurAdresses
 *
 * @ORM\Table(name="lafleur_adresses", indexes={@ORM\Index(name="fk_adresse_ville1_idx", columns={"ville_id"}), @ORM\Index(name="fk_adresse_code_postal1_idx", columns={"code_postal_id"})})
 * @ORM\Entity
 */
